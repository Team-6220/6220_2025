...
public final class Constants {
  ...
  public final TunableNumber autoMaxVelocity =
      new TunableNumber("autoMaxVelocity", AutoConstants.autoMaxVelocityMps);
  public final TunableNumber autoMaxAcceleratMpsSq =
      new TunableNumber("autoMaxAcceleratMpsSq", AutoConstants.autoMaxAcceleratMpsSq);
  public final TunableNumber maxAngularVelocityRps =
      new TunableNumber("maxAngularVelocityRps", AutoConstants.maxAngularVelocityRps);
  public final TunableNumber maxAngularAcceleratRpsSq =
      new TunableNumber("maxAngularAcceleratRpsSq", AutoConstants.maxAngularAcceleratRpsSq);
  ...
  public static final class VisionConstants {
    ...
    public static final double speakerTagID =
        ALLIANCE_COLOR.isPresent()
            ? ALLIANCE_COLOR.get() == DriverStation.Alliance.Red ? 4d : 7d
            : -1d;
  }
  ...
  public static final class SwerveConstants {
    ...
    public static final double trackWidth =
        Units.inchesToMeters(21); // TODO: This must be tuned to specific robot
    public static final double wheelBase =
        Units.inchesToMeters(26); // TODO: This must be tuned to specific robot
    ...
    public static final boolean angleMotorInvert =
        chosenModule.driveMotorInvert == InvertedValue.CounterClockwise_Positive;
  ...
  public static final class ElevatorConstants {
    ...
    public static final double elevatorKv =
        9.1; // Or 10.5, this was the old kv, something like that :) You got this Nathan //frc
    ...
    public static final double elevatorMaxVel =
        1.26; // Ok tune this a little higher/lower//meters per second
    public static final double elevatorMaxAccel =
        4; // I think you don't need to tune this one but you can//meters per second square
