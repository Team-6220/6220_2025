...
public final class WristConstants {
  ...
  /*
   * old end factor values
   * kp = 0.08, i and d is zero, i zone =2, tolerance =1, s = 0, g = .25
   */

  public static final double kP = 0.09, kI = 0, kD = 0.005, izone = 2, tolerance = 1.0;
  public static final double kS = 0, kG = .5, kV = 0, kA = 0;
  public static final double allowedClosedLoopError = 0.5;
