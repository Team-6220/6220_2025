      ...
      if (!results.get(i).isEmpty()) {
        ...
        if (bestTarget.get(i) != null) {
          ...
          SmartDashboard.putNumber(
              tableKey + i + "camera to pose measure x", camToTar.getMeasureX().abs(Meters));
          SmartDashboard.putNumber(
              tableKey + i + "camera to pose measure y", camToTar.getMeasureY().abs(Meters));
          SmartDashboard.putNumber(
              tableKey + i + "camera to pose measure z", camToTar.getMeasureZ().abs(Meters));
