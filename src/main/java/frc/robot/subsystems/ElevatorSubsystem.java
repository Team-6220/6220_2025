...
public class ElevatorSubsystem extends SubsystemBase {
  ...
  private final TunableNumber elevatorKd =
      new TunableNumber("Elevator kD", ElevatorConstants.elevatorKd);
  private final TunableNumber elevatorKg =
      new TunableNumber("Elevator kG", ElevatorConstants.elevatorKg);
  private final TunableNumber elevatorKv =
      new TunableNumber("Elevator kV", ElevatorConstants.elevatorKv);
  private final TunableNumber elevatorKa =
      new TunableNumber("Elevator kA", ElevatorConstants.elevatorKa);
  ...
  private final TunableNumber elevatorMaxAccel =
      new TunableNumber("Elevator max accel", ElevatorConstants.elevatorMaxAccel);

  private final TunableNumber elevatorSetpoint =
      new TunableNumber("Elevator goal setpoint", ElevatorConstants.elevatorEncoderOffset);
  ...
  */
  ...
  public ElevatorSubsystem() {
    ...
    m_Controller =
        new ProfiledPIDController(
            elevatorKp.get(), elevatorKi.get(), elevatorKd.get(), m_Constraints);
  ...
  public void periodic() {
    ...
    if (elevatorMaxVel.hasChanged() || elevatorMaxAccel.hasChanged()) {
      m_Constraints =
          new TrapezoidProfile.Constraints(elevatorMaxVel.get(), elevatorMaxAccel.get());
      m_Controller.setConstraints(m_Constraints);
      System.out.println(
          "constraints created w/ new max vel"
              + elevatorMaxVel.get()
              + ", max accel"
              + elevatorMaxAccel.get());
    }
    ...
    if (elevatorTolerance.hasChanged()) {
      m_Controller.setTolerance(elevatorTolerance.get());
      System.out.println("New tolerance:" + elevatorTolerance.get());
    }
  }
