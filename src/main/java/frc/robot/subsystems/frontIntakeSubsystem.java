...
public class frontIntakeSubsystem extends SubsystemBase {
  ...
  private final TunableNumber FrontIntakeKp =
      new TunableNumber(
          "FrontIntake kP",
          FrontIntakeConstants.frontIntakeKp); // TODO: match/make to constant.java
  private final TunableNumber FrontIntakeKi =
      new TunableNumber("FrontIntake kI", FrontIntakeConstants.frontIntakeKi);
  private final TunableNumber FrontIntakeKd =
      new TunableNumber("FrontIntake kD", FrontIntakeConstants.frontIntakeKd);
  private final TunableNumber FrontIntakeKg =
      new TunableNumber("FrontIntake kG", FrontIntakeConstants.frontIntakeKg);
  private final TunableNumber FrontIntakeKv =
      new TunableNumber("FrontIntake kV", FrontIntakeConstants.frontIntakeKv);
  private final TunableNumber FrontIntakeKs =
      new TunableNumber("FrontIntake kS", FrontIntakeConstants.frontIntakeKs);
  private final TunableNumber FrontIntakeKa =
      new TunableNumber("FrontIntake kA", FrontIntakeConstants.frontIntakeKa);
  private final TunableNumber FrontIntakeIZone =
      new TunableNumber("FrontIntake izone", FrontIntakeConstants.frontIntakeIZone); // default 3
  private final TunableNumber FrontIntakeTolerance =
      new TunableNumber(
          "FrontIntake tolerance", FrontIntakeConstants.frontIntakeTolerance); // default 1.5

  private final TunableNumber FrontIntakeMaxVel =
      new TunableNumber("FrontIntake max vel", FrontIntakeConstants.frontIntakeMaxVel);
  private final TunableNumber FrontIntakeMaxAccel =
      new TunableNumber("FrontIntake max accel", FrontIntakeConstants.frontIntakeMaxAccel);

  private final TunableNumber frontIntakeIdleVoltage =
      new TunableNumber("lower intake idle voltage", FrontIntakeConstants.idleSpinVoltage);
  private final TunableNumber frontIntakeVoltage =
      new TunableNumber("lower intake voltage", FrontIntakeConstants.wheelSpeed);
  private double idleOutVolt = FrontIntakeConstants.idleSpinVoltage,
      intakeOutVolt = FrontIntakeConstants.wheelSpeed; // place holder when update the voltages
  ...
  private SparkMaxConfig motorLeftConfig = new SparkMaxConfig(),
  ...
  public frontIntakeSubsystem() {
    ...
    m_Constraints =
        new TrapezoidProfile.Constraints(FrontIntakeMaxVel.get(), FrontIntakeMaxAccel.get());

    m_Controller =
        new ProfiledPIDController(
            FrontIntakeKp.get(), FrontIntakeKi.get(), FrontIntakeKd.get(), m_Constraints);
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber(
        tableKey + "intakeMotorTemp", frontMotor.getDeviceTemp().getValueAsDouble());
    SmartDashboard.putNumber(
        tableKey + "intakeMotorTorqueCurrentDraw",
        frontMotor.getTorqueCurrent().getValueAsDouble());
    SmartDashboard.putNumber(
        tableKey + "intakeMotorSupplyCurrentDraw",
        frontMotor.getSupplyCurrent().getValueAsDouble());
    SmartDashboard.putNumber(
    ...
    if (FrontIntakeKs.hasChanged() || FrontIntakeKg.hasChanged() || FrontIntakeKv.hasChanged()) {
      m_Feedforward =
          new ArmFeedforward(
              FrontIntakeKs.get(),
              FrontIntakeKg.get(),
              FrontIntakeKv.get(),
              FrontIntakeConstants.frontIntakeKa);
      System.out.println(
          "new ff;s:"
              + FrontIntakeKs.get()
              + "g:"
    ...
    if (FrontIntakeMaxVel.hasChanged() || FrontIntakeMaxAccel.hasChanged()) {
      m_Constraints =
          new TrapezoidProfile.Constraints(FrontIntakeMaxVel.get(), FrontIntakeMaxAccel.get());
      m_Controller.setConstraints(m_Constraints);
      System.out.println(
          "new contraints;max vel:"
              + FrontIntakeMaxVel.get()
              + "max accel:"
              + FrontIntakeMaxAccel.get());
    }
  ...
  public double getPosition() {
    return (((lowerintakeEncoder.get()+0.4) %1) * (24.0 / 32.0) * 360.0)//chaged for misaligned encoder
        -117 - 18; // (encoder value - offset) * gear ratio from shaft to encoder *360 to get degrees
  }
