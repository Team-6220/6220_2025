...
public class LEDCANdle extends SubsystemBase {
  ...
  */
  ...
  public void setTwinkle() {
    candleLED.clearAnimation(0);
    candleLED.animate(
        new TwinkleAnimation(255, 255, 255, 255, 16.0, 308, TwinklePercent.Percent42), 0);
  }

  public void setModifiable(int m) {
    // candleLED.animate(new RainbowAnimation(.5, 0.5, 308));
    candleLED.clearAnimation(0);
    // candleLED.animate(new TwinkleAnimation(255,255,255,255,16.0,308, TwinklePercent.Percent42),
    // 0);
