...
public class CoralStationCmd extends Command {
  ...
  // private final TunableNumber xMaxVel = new TunableNumber("x MaxVel",
  // Constants.SwerveConstants.xMaxVel);
  // private final TunableNumber xMaxAccel = new TunableNumber("x Accel",
  // Constants.SwerveConstants.xMaxAccel);
  ...
  // private final TunableNumber yMaxVel = new TunableNumber("y MaxVel",
  // Constants.SwerveConstants.yMaxVel);
  // private final TunableNumber yMaxAccel = new TunableNumber("y Accel",
  // Constants.SwerveConstants.yMaxAccel);
  ...
  public void execute() {
    ...
    //  if(autoDrive.getAsBoolean() || (m_Controller.getLeftBumperButton() ||
    // m_Controller.getRightBumperButton()))
    //  {
