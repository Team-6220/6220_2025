...
public class Stage4CMD extends Command
{
  ...
  public Stage4CMD(Swerve s_Swerve, XboxController m_Controller, Supplier<Boolean> leftControl, Supplier<Boolean> rightControl, int cameraNum)
  {
  ...
  public Stage4CMD(Swerve s_Swerve, int cameraNum, Supplier<Boolean> leftControl, Supplier<Boolean> rightControl)
  {
    elevator = ElevatorSubsystem.getInstance();
    wrist = V2_SparkMaxWristSubsystem.getInstance();
    s_Photon = PhotonVisionSubsystem.getInstance();
